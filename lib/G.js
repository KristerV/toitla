G = {
    ...
    validateDetails: function(menuitem, onlyCheckThisField) {
        ...
        var errors = {}
        var required = onlyCheckThisField ? [onlyCheckThisField] : ['title', 'ingredients', 'foodType', 'priceClass', 'weight']
        if (menuitem.inorder)
        ...
        var mustBeNumber = onlyCheckThisField ? [onlyCheckThisField] : ['weight']
        if (menuitem.inorder)
            mustBeNumber.push('amount')
