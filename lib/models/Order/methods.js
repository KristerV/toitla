    ...
    'Order--sendConfirmationEmails': function(orderId) {
        ...
        if (Roles.userIsInRole(this.userId, 'manager') && Meteor.isServer) {
            ...
            chefsNotConfirmed.forEach(chefId => {
                ...
                var html = ""
                html += "Tsau " + user.profile.name + ","
                html += "<p>Sulle on tulnud uus tellimus. Palun märgi parempoolsesse kasti, et võtad toidu tellimuse vastu. Tee seda iga toidu kohta eraldi.</p>"
